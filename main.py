    ...
    if client:
        try:
            ...
            analysis_prompt = (
                ...
                "5. ЗОЛОТОЙ СТАНДАРТ: Если у канала > 1 млн сабов, охват поста > 15% и ERR > 10% — это ЭТАЛОННЫЙ живой канал. "
                "6. СМИ-гиганты: Если CI > 10 000 и охват > 500k — это норма для федеральных каналов."
            )
